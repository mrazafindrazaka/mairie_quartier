...
<?php require 'headerView.php'; ?>
    ...
    <div class="container spacing">
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="mb-2">
                    ...
                    <div class="form-check-inline">
                        <label class="form-check-label">
                            <input id="non" type="radio" class="form-check-input" name="info" value="non" checked/>Non
                        </label>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-12">
                ...
                <form action="index.php">
                    <div class="input-group mb-2">
                        ...
                        <input id="ville_nom" type="text" class="form-control" name="nom" placeholder="ville"
                               value="<?= $nom; ?>" required/>
                    </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <span class="result-box">Ville : <?= $ville; ?></span>
                <span class="result-box">Mairie : <a href="<?= $link; ?>" target="_blank"><?= $mairie; ?></a></span>
                <span class="result-box">Alternative : <?= $alternative; ?></span>
            </div>
        </div>
    </div>
